...
<html lang="en">
    ...
    <body id="mimin" class="dashboard">
        ...
        <div class="container-fluid mimin-wrapper">
            ...
            <!-- VENTANA POPUP PARA AÑADIR UN PRODUCTO NUEVO -->
                    ...
                    <div class="col-md-12 padding-0">
                        <div class="panel box-shadow-none content-header">
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <h3 class="animated fadeInLeft">Añade productos nuevos</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 padding-0">
                        <div class="col-md-12 padding-0">
                            <div class="panel box-shadow-none content-header">
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <h3 class="animated fadeInLeft">Administración de Productos</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box-v5 panel">
                                <div class="panel-body">
                                    <div class="panel-heading" style="text-align:center;">
                                        ...
                                        <!--<a href="adProductos" class="btn btn-default"> Añadir </a>-->
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" style="width: 100%;" width="100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="gradeA odd" role="row">
                                                                ...
                                                                <td>
                                                                    <a class="btn btn-primary btn-xs" href="{{ action('ProductosController@edit', $producto->idProducto) }}" ><span class="glyphicon glyphicon-pencil"></span></a>
                                                                  <!--<a class="btn btn-primary btn-xs" href="/adminProd/{{$producto->idProducto}}/editProducto" ><span class="glyphicon glyphicon-pencil"></span></a>-->
                                                                    <form action="{{ action('ProductosController@destroy', $producto->idProducto) }}" method="POST">
                                                                        {{ method_field('DELETE') }}
                                                                        {{ csrf_field() }}
                                                                        <!-- <input name="_method" type="hidden" value="DELETE">-->
                                                                        <button class="btn btn-danger btn-xs btn-delete" type="button"><span class="glyphicon glyphicon-trash"></span></button> 
                                                                    </form>
            ...
            <script>
                ...
                $('.btn-delete').on('click', function (e) {
                    if (confirm('¿Seguro que quiere borrar leste producto?')) {
